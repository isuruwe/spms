...
*/
class meddet extends StatefulWidget {
  // final String p1;
  // final  plist;
  // final Function() notifyParent;
  // players({ required this.plist, required this.notifyParent}) ;
  @override
  _meddetState createState() => _meddetState();
}

class _meddetState extends State<meddet> {
  @override
  void initState() {
    super.initState();
  }
  ...
  //     list.add( itemWidget(name: entry["Serviceno"] + " " + entry["Rank"]  ,
  //         amount: entry["Name"],
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // },
          itemWidget(
              name: 'Medical Fitness', amount: '', icon: AppAssets.user1),
          itemWidget(
              name: 'Physical Fitness', amount: '', icon: AppAssets.user1),
          itemWidget(
              name: 'Psychological Fitness', amount: '', icon: AppAssets.user1),
          itemWidget(
              name: 'Nutritional Fitness', amount: '', icon: AppAssets.user1),
          itemWidget(name: 'Anti-Doping', amount: '', icon: AppAssets.user1),
        ],
      ),
    );
  }
