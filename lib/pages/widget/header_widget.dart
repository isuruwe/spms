      ...
      child: Row(
        ...
        children: [
          ...
          if (MediaQuery.of(context).size.width > 1180) ...{
            ...
            Text(
              "Sri Lanka Air Force",
              style: TextStyle(color: AppColors.bitBucketBgColor, fontSize: 25),
            ),
            // SizedBox(
            //   width: 10,
            // ),
  ...
  Widget logoWidget() {
    return Row(
      ...
      children: [
        ...
        Text(
          "SPORTS POOL MANAGEMENT SYSTEM",
          style: TextStyle(color: AppColors.interComeBgColor, fontSize: 25),
        )
      ],
    );
  }
